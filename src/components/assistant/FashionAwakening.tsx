...
export const FashionAwakening = () => {
  ...
  return (
    <div className="fashion-awakening">
      {/* 洗练类型选择 */}
      <div className="fashion-awakening__type-selector">
        <button
          className={`type-btn ${
      ...
      <div className="fashion-awakening__container">
      <div className="fashion-awakening__board">
        {/* 标题栏 */}
        <div className="fashion-awakening__header">
          <div className="fashion-awakening__header-content">
            <h3 className="fashion-awakening__title">
              {blessingType === "goddess" ? "女神的祝福" : "恶魔的祝福"}
            </h3>
            <span className="fashion-awakening__subtitle">Item to awake</span>
          </div>
        </div>

        <div className="fashion-awakening__item-slot">
          <div className="fashion-awakening__item-wrapper">
            <img
        ...
        <div className="fashion-awakening__stats">
          {/* 左侧属性 */}
          <div
            data-side="left"
        ...
        <div className="fashion-awakening__actions">
          <div className="fashion-awakening__actions-content">
            <div className="actions-main">
            <button
              className="fashion-awakening__start-btn"
            ...
            >
              ...
              <button
                  className="fashion-awakening__stop-btn"
        ...
        {/* 预设属性选择 */}
        <div className="fashion-awakening__preset">
          ...
          <div className="preset-options">
            ...
            <div className="preset-option">
              <button
                className="fashion-awakening__history-btn"
