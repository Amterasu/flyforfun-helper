...
<div align="center"><img src="./assets/banner.png" alt="banner.png" width="640"/></div>
...
* `2023-12-21 10:00 UTC`:New Asia server `莱斯` starts.
...
* `2023-05-18 07:00 UTC ~ 2023-05-25 06:59 UTC`:Special Item Shop Discount `20%` discount.
...
* A whole day is `14` minutes and `24` seconds (`14:24`).

   > 遊戲中一天是現實世界 `14` 分 `24` 秒（`14:24`)。

* Night is `6` minutes and `36` seconds(`6:36`), from `19:00` to `06:00`.

   > 夜晚為現實世界 `6` 分 `36` 秒（`6:36`），從遊戲世界 `19:00` 到 `06:00`。
...
* The monsters in these **6 new dungeons** (Leren Chasm, 莱斯 Catacombs, Envy Depths, Guardian Sanctuary, Storm Peak, The Wilds) have no level. They are balanced according to the required entry level, but they do not interact the same way as other monsters in terms of level difference penalties.
...
* This purchase gives you many advantages during the Battle Pass season:
   ...
   9. Second stat page:There is a `15` minute cool down between each swap.
      ...
      * Each stat page has its own `STR`, `DEX`, `INT`, `STA`, and remaining stat points.
...
#### 👗 costume collection details

<div align="center">

**For more information please refer to [Costume Collection](./Costume%20Collection.md "Formulas.md").**
...
<img src="./upgrade/weapon&armor_upgrade.png" alt="weapon&armor_upgrade.png"/></div>
...
* The stat can be anywhere from `+1` to `+4`.

* This replaces any existing stat on the weapon or armor.
...
> source:[Flyff Universe Developer Q&A October - November 2022 Questions](https://wcdn-universe.flyff.com/site/qna_11_2022.pdf "Flyff Universe Developer Q&A October - November 2022 Questions")

> source:[Game Version 1.2.5 Patch Notes](https://universe.flyff.com/news/patchnotes125 "Game Version 1.2.5 Patch Notes")

<div align="center"><img src="./pet/pet_defect_recycling.png" alt="pet_defect_recycling.png"/></div>
...
<div align="center"><img src="./pet/berryfarming_map_v4.jpg" alt="berryfarming_map_v4.jpg" width="800"/></div>

> source:[@cysotiso @[Zanarkand] Cysotiso (discord flyff universe)](https://discord.com/channels/778915844070834186/1000058902576119878/1374779011661693099 "@cysotiso @[Zanarkand] Cysotiso (discord flyff universe)")
...
<div align="center"><img src="./pet/transmutes/nine_tails.jpg" alt="nine_tails.jpg" width="400"></div>

4. [Tonge](https://flyffipedia.com/items/details/11407 "Tonge Cage")
   * `2023-02-02 ~ 2023-04-12`

<div align="center"><img src="./pet/transmutes/tonge.jpg" alt="tonge.jpg" width="400"></div>
...
<div align="center"><img src="./pet/transmutes/skating_cat.jpg" alt="skating_cat.jpg" width="400"></div>
...
* Added new repeatable quests that reward weapon piercing card select boxes for a certain number of final dungeon boss kills. **[version 1.2.2](https://universe.flyff.com/news/patchnotes122 "Game Version 1.2.3 Patch Notes")**
   > 新增了可重複完成的任務，完成擊殺一定數量的副本最終 boss 後，會獲得武器穿洞卡片選擇盒。
...
* Added treasure chests to all instanced dungeons, which can contain Essential boxes, Element Attack boxes, Pill boxes, and Rainbow Cotton candies. **[version 1.2.3](https://universe.flyff.com/news/patchnotes123 "Game Version 1.2.3 Patch Notes")**
   > 為所有實例副本(副本)添加了寶箱，其中可以包含必需品盒、元素攻擊盒、藥丸盒和彩虹棉花糖。
...
* Instanced dungeon (specifically Reborn dungeons) monsters do not have a drop penalty based on level due to the scaled nature of the monsters.
   > 由於怪物的縮放性質，實例副本（特別是重生副本）怪物沒有基於等級的掉落懲罰。
...
* Under the hood dungeon monsters have a level as seen in the API, but all penalties are removed from dungeon monsters. So there should be no effect to drops, etc. based on level.
   > 真正的原因是副本怪物有一個等級，如 API 中所示，但所有懲罰都從副本怪物中刪除，所以基於等級的掉落率應該沒有影響。
...
<div align="center"><img src="./dungeons/dungeons_drops.png" alt="dungeons_drops.png"/></div>

<div align="center"><img src="./dungeons/cursed_jewelry_fragment_drop_in_dungeons.png" alt="cursed_jewelry_fragment_drop_in_dungeons.png"/></div>
...
| Template | Size | Price |
|:---:|:---:|:---:|
| Blank World | S | 💲100,000,000 金币 |
| Blank World | M | 💲200,000,000 金币 |
| Blank World | L | 💲2,250,000,000 金币 |
| Blank World | XL | 💲4,000,000,000 金币 |
| Beach World | S | 💲400,000,000 金币 |
| Darken World</br>Forest World</br>Volcano World</br>Snow World</br>Fall World | S | 💲100,000,000 金币 |
...
* 💲7,000,000 金币
  ...
  * [Personal House NPC] BB Wolf (7 days): Jump Height +30

* 💎70(7 days)/💎140(15 days)

  * [Personal House NPC] Hatter: PvE Damage +3%

  * [Personal House NPC] Alice: PvE Damage Reduction +3%

  * [Personal House NPC] Rulu: Experience Loss Reduction +3% (Decreased from 3% to 2.91%.)
  ...
  * [Personal House NPC] Tino: Added Vendor Shop Day(s) +1.

  <!-- * *<ins>Not released yet</ins> [Personal House NPC] Cachu: Party Exp +10%* -->

  * [Personal House NPC] Casanova: Monster EXP +5%

  * [Personal House NPC] Misun: Item Drop Rate +5%

  * [Personal House NPC] Temas: Speed +5%

  * [Personal House NPC] Chacha: Flying Speed +5%　　
  ...
  * [Personal House NPC] Mac (A Grade): Pet Training (Pet Candy A)

  * [Personal House NPC] Mac (B Grade): Pet Training (Pet Candy B)

  * [Personal House NPC] Mac (C Grade): Pet Training (Pet Candy C)

  * [Personal House NPC] Mac (D Grade): Pet Training (Pet Candy D)

  * [Personal House NPC] Mac (E Grade): Pet Training (Pet Candy E)

  * [Personal House NPC] Mac (F Grade): Pet Training (Pet Candy F)
...
* 💎350(7 days)/💎700(15 days)
  ...
  * [Guild House NPC] Vikel: PvP Melee/Range Block +3%

  * [Guild House NPC] Quarter: Increased HP +10%

  * ~~[Guild House NPC] Sham: Increased MP +10%~~ **Removed [Minor Fixes after 2024/02/28 Maintenance](https://universe.flyff.com/news/minorfixesfebruary28 "Minor Fixes after 2/28 Maintenance")**

  * [Guild House NPC] Lamew: Increased FP +10%
